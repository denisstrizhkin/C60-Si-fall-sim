...
- [ ] Анализ полученных результатов для одиночных случаев наибольшего и наименьшего распыления
...
- [ ] Удлинить кристалл в направлении падения фуллерена на 11 ячеек
- [ ] Проверить, чтоб он остывал, запустить 300 случаев

### Задача 2

- [ ] Для самого и большого распыления ступеньки сохранить положение атомов
- [ ] Сдвинуть отраженный фуллерен на 12 кадре
- [ ] Определять нижний и верхний атомы и сравнивать их энергии от времени
