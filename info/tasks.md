...
- [ ] Рассмотреть возможность использования ReaxFF (или другого потенциала) для анализа падения С60 на кремний в присутствии кислорода; в присутствии молекул воды. Моделировать предполагается распыление и формирование поверхностных структур при одиночных падениях, потом, возможно, переход к кумулятивному моделированию. Идея - доказать, что химпроцессы влияют на распыление
- [ ] Подобрать потенциал для моделирования падения С60 и Ar_n на SiO2
- [ ] Вернуться к вопросу анализа строения углеродной пленки (кольца, плоскости; думать, как еще можно обнаруживать появление нанокластеров углерода)
